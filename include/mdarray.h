...
public:
    array3d() = default;
    array3d(std::size_t N, std::size_t M, std::size_t P) : N(N), M(M), P(P), vec(N*M*P){}
    array3d(std::size_t N, std::size_t M, std::size_t P, T val) : N(N), M(M), P(P), vec(N*M*P, val){}
...
public:
    array2d() = default;
    array2d(std::size_t N, std::size_t M) : N(N), M(M), vec(N*M){}
    array2d(std::size_t N, std::size_t M, T val) : N(N), M(M), vec(N*M, val){}
